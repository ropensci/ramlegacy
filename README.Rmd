...
## Installation
You can install the development version from [GitHub](https://github.com/ramlegacy/ramlegacy) with:

```{r, eval = FALSE, echo = TRUE}
install.packages("devtools")
library(devtools)
install_github("ramlegacy/ramlegacy")
```
...
## Usage
Please see the ramlegacy [vignette](https://ramlegacy.github.io/ramlegacy/articles/ramlegacy.html) for more detailed examples and additional package functionality. 
