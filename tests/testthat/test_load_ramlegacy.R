...
test_that("load_ramlegacy errors out when version is not present locally", {
  ...
  # pass in the path to rds to load_ramlegacy
  rds_path <- file.path(temp_path, "1.0/v1.0.rds")
  expect_error(load_ramlegacy("1.0", rds_path),
